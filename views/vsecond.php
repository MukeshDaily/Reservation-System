...
<div class="rt_tophead">Bus Details</div>
...
<br>
<img src="http://127.0.0.1/01bussystem/busimage/<?php echo $busarr[11];?>.png" width=900 height=200><br>

                    <div class="signup_right">
<div class="rt_tophead">Select The Seats to Reserve(Rs. <?php  echo $busarr[8]; ?> Per seat)</div>
...
//add seat names
a[q]=document.getElementById(q).value;
...
var comma=0;
  ...
  if(a[item]!=0){
   if(comma==0)
   {
   document.getElementById("seatno").value+=a[item];
   }
   else
   {
   document.getElementById("seatno").value+=","+a[item];
...
<td>
<div class="rowContainer"> 					
<input type="text" name="daty" value="<?php echo $dt;?>" onfocus="blur();">
</div>
</td>
<td>
<div class="rowContainer"> 
<input type="text" name="busid" value="<?php echo $id;?>" onfocus="blur();">
</div>
</td>
<td>
<div class="rowContainer"> 
